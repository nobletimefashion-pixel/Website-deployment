#to manage multiple mcp servers
import asyncio
from typing import Any
from nexus_agent.config.config import Config
from nexus_agent.Tools.mcp.client import MCPClient, MCPServerStatus
from nexus_agent.Tools.mcp.mcp_tool import MCPTool
...
class MCPManager:
    ...
    async def initialize(self) -> None:
        ...
        mcp_configs = self.config.mcp_server
        ...
        connection_tasks = [
            asyncio.wait_for(
                client.connect(),
                timeout=client.config.startup_timeout_seconds,
            )
