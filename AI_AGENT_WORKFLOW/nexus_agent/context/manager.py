...
from nexus_agent.client.response import TokenUsage
from nexus_agent.config.config import Config
from nexus_agent.prompts.system import get_system_prompt
from dataclasses import dataclass, field
from nexus_agent.utils.text import count_token
    ...
    def prune_tool_outputs(self) -> int:
        ...
        for msg in reversed(self._messages):
            if msg.role == "tool" and msg.tool_call_id:
                ...
                tokens = msg.token_count or count_token(msg.content, self._model_name)
                total_tokens += tokens
        ...
        for msg in to_prune:
            ...
            msg.token_count = count_token(msg.content, self._model_name)
